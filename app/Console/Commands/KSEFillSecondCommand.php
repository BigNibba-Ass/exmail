...
class KSEFillSecondCommand extends Command
{
    protected $signature = 'kse:fill-second';

    protected $description = 'todo';

    public function handle(): void
    {
        $serviceId = Company::firstOrCreate(['name' => 'KSE'])->services()->firstOrCreate(['name' => 'Экспресс доставка'])->id;
        $this->fillZones($serviceId);
        $this->setTerms($serviceId);
        $this->setPricesForSecond($serviceId);
    }
